...
const content = {
  ja: {
    ...
    learning: "ユーザーの発言をそのまま機能に変えるのではなく、複数の声を整理し、その背後にある共通の文脈やニーズを見つけることが重要だと学びました。",
  ...
  en: {
    ...
    learning: "I learned not to turn individual comments directly into features, but to organise multiple voices and identify their shared contexts and needs.",
    videoLabel: "PROJECT VIDEO",
